...
const AnalysisCard = ({ pr }: any) => {
  ...
  return (
    <div className="card card-compact w-80 bg-base-100 shadow-xl m-4 flex flex-row justify-center items-center p-2 m-2 cursor-pointer" onClick={() => window.open(pr.link, "_blank")}>
      <figure>
