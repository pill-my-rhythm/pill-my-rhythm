      ...
      <div className="w-full py-20 min-h-screen flex flex-col md:flex-row items-center justify-center">
        <div className="card m-4 w-[25rem] glass p-2 md:p-4 flex flex-wrap items-center justify-center">
          <div className="p-4 md:p-2 avatar">
            <div className="w-48 mask mask-squircle">
              <img
                src="https://blog.kakaocdn.net/dn/btisU7/btrGhwSz90s/MXez6Ltsz0DKL7HzDnhczk/img.png"
                alt="클리니컬 글루타치온"
              />
            </div>
          </div>
        ...
        <div className="card m-4 w-[25rem] glass p-2 md:p-4 flex flex-wrap items-center justify-center">
          <div className="p-4 md:p-2 avatar">
            <div className="w-48 mask mask-squircle">
              <img
                src="https://blog.kakaocdn.net/dn/cessjF/btrGgJkzzlh/XtZP90N25PiFjzQ4bKPZk0/img.png"
                alt="엔젯오리진 빌베리 루테인 토탈 아이케어"
              />
            </div>
          </div>
          <div className="card-body p-2 m-2 break-words text-center">
        ...
        <div className="card m-4 w-[25rem] glass p-2 md:p-4 flex flex-wrap items-center justify-center">
          <div className="p-4 md:p-2 avatar">
            <div className="w-48 mask mask-squircle">
              <img
                src="https://blog.kakaocdn.net/dn/uWqi8/btrGjFA3jd5/6DvOPYCm7dtcVCbVc4afJ1/img.png"
                alt="정관장 홍삼정 에브리타임"
              />
            </div>
          </div>
