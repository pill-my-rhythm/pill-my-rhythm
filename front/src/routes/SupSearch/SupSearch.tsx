...
import { Wrap, SearchHeader, SearchWrapper, InputWrapper, Input, LsWrapper, Form, SearchInp, VerticalDvd, BtnWrapper } from "./SupStyled";
          ...
          <InputWrapper>
            <Input className="shadow-lg">
              <LsWrapper>
                ...
                <Form>
                  <SearchInp placeholder="영양제 검색하기" />
                </Form>
              </LsWrapper>
              <VerticalDvd />
              <BtnWrapper>
